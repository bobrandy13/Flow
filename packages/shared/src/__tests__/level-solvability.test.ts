...
const expectedDesigns: Record<string, Diagram> = {
  ...
  "04-add-a-cache": {
    nodes: [
      ...
      { id: "s2", kind: "server", position: { x: 400, y: 0 } },
      { id: "s3", kind: "server", position: { x: 400, y: 60 } },
    ...
    edges: [
      ...
      { id: "e5", fromNodeId: "s1", toNodeId: "ca", cacheHitRate: 0.8 },
      { id: "e6", fromNodeId: "s2", toNodeId: "ca", cacheHitRate: 0.8 },
      { id: "e7", fromNodeId: "s3", toNodeId: "ca", cacheHitRate: 0.8 },
      { id: "e8", fromNodeId: "ca", toNodeId: "d" },
      { id: "e9", fromNodeId: "s1", toNodeId: "c" },
      { id: "e10", fromNodeId: "s2", toNodeId: "c" },
      { id: "e11", fromNodeId: "s3", toNodeId: "c" },
    ],
  },
  "05-smooth-the-burst": {
    nodes: [
